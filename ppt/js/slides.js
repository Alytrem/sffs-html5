...
function addPrettify() {
  ...
  el.src = PERMANENT_URL_PREFIX + 'js/prettify/prettify.js';
  el.onload = function() {
    prettyPrint();
  }
...
function addFontStyle() {
  ...
  el.rel = 'stylesheet';
  el.type = 'text/css';
  el.href = PERMANENT_URL_PREFIX + 'styles/fonts.css';
...
function addGeneralStyle() {
  ...
  el.rel = 'stylesheet';
  el.type = 'text/css';
  el.href = PERMANENT_URL_PREFIX + 'styles/slides.css';
  document.body.appendChild(el);
...
function addPageNumber(){
    for (var i = 0; i < slideEls.length; i++) {
        ...
        if(el && typeof el.appendChild == "function"){
            var no = i + 1;
            el.innerHTML += "<p class='pageno'>"+no+" / "+slideEls.length+"</p>";
        }
    }
}
